...
const PRESETS: Record<string, PresetEntry[]> = {
  ...
  'Дом снаружи': [
    ...
    ['komora', 'кладовая'], ['špajza', 'кладовая'], ['pracovňa', 'кабинет'],
  ...
  'Дом внутри': [
    ...
    ['žalúzie', 'жалюзи'], ['paplón', 'одеяло'], ['prikrývka', 'одеяло'],
  ...
  'Утварь': [
    ...
    ['bioodpad', 'биоотходы'], ['škvrna', 'пятно'], ['fľak', 'пятно'],
  ],
  'Материалы и инструменты': [
    ...
    ['majster', 'мастер', 'noun'], ['opravár', 'ремонтник', 'noun'], ['údržbár', 'ремонтник', 'noun'],
  ],
  'Прилагательные': [
  ...
  'Цвета': [
    ...
    ['mnohofarebný', 'разноцветный', 'adjective'], ['pestrý', 'разноцветный', 'adjective'], ['priehľadný', 'прозрачный', 'adjective'],
    ['farba', 'цвет', 'noun'],
  ],
  'Одежда': [
    ['košeľa', 'рубашка', 'noun'], ['tričko', 'футболка', 'noun'],
    ['nohavice', 'брюки', 'noun'], ['šortky', 'шорты', 'noun'], ['kraťasy', 'шорты', 'noun'],
    ['ponožky', 'носки', 'noun'], ['topánky', 'ботинки', 'noun'], ['obuv', 'обувь', 'noun'],
    ['čižmy', 'сапоги', 'noun'], ['sukňa', 'юбка', 'noun'],
    ['šaty', 'платье', 'noun'], ['sako', 'пиджак', 'noun'],
    ['kabát', 'пальто', 'noun'], ['bunda', 'куртка', 'noun'], ['oblek', 'костюм', 'noun'],
    ['čiapka', 'шапка', 'noun'],
  ...
  'Наречия частоты': [
    ...
    ['niekedy', 'иногда', 'adverb'], ['zvyčajne', 'обычно', 'adverb'], ['obyčajne', 'обычно', 'adverb'],
    ...
    ['opäť', 'снова', 'adverb'], ['znovu', 'снова', 'adverb'], ['raz', 'раз, однажды', 'adverb'],
    ...
    ['stále', 'постоянно', 'adverb'], ['neustále', 'постоянно', 'adverb'], ['momentálne', 'в данный момент', 'adverb'], ['aktuálne', 'в данный момент', 'adverb'],
  ],
  'Наречия: степень и образ действия': [
    ...
    ['trochu', 'немного', 'adverb'], ['iba', 'только', 'adverb'], ['len', 'только', 'adverb'], ['tiež', 'также', 'adverb'],
  ...
  'Направления и расположение': [
    ...
    ['bohužiaľ', 'к сожалению', 'adverb'], ['žiaľ', 'к сожалению', 'adverb'],
  ],
  'Местоимения': [
  ...
  'Люди и семья': [
    ...
    ['privítať', 'поприветствовать', 'verb'], ['lúčiť sa', 'прощаться', 'verb'], ['rozlúčiť sa', 'попрощаться', 'verb'],
  ...
  'Вежливые слова и приветствия': [
    ...
    ['ďakujem', 'спасибо', 'interjection'], ['prepáč', 'извини', 'interjection'], ['pardon', 'извините', 'interjection'],
    ...
    ['pozvať', 'пригласить', 'verb'], ['odmietnuť', 'отказать', 'verb'], ['odmietať', 'отказывать', 'verb'],
    ['sľúbiť', 'пообещать', 'verb'], ['sľubovať', 'обещать', 'verb'], ['navrhnúť', 'предложить', 'verb'],
    ['radiť', 'советовать', 'verb'], ['poprosiť', 'попросить', 'verb'],
    ['oznámiť', 'сообщить', 'verb'], ['informovať', 'информировать', 'verb'],
    ['opísať', 'описать', 'verb'], ['porovnať', 'сравнить', 'verb'], ['porovnávať', 'сравнивать', 'verb'],
  ],
  'Работа и профессии': [
    ...
    ['recepčná', 'администратор', 'noun'], ['opatrovateľ', 'сиделка', 'noun'], ['opatrovateľka', 'опекун', 'noun'],
  ...
  'Документы и бюрократия': [
    ['doklad totožnosti', 'удостоверение личности', 'noun'], ['občiansky preukaz', 'удостоверение личности', 'noun'],
  ...
  'Природа и погода': [
    ...
    ['vlhký', 'влажный', 'adjective'], ['oblačný', 'облачно', 'adjective'], ['polooblačný', 'переменная облачность', 'adjective'],
  ...
  'Языки': [
    ...
    ['nárečie', 'диалект', 'noun'], ['dialekt', 'диалект', 'noun'], ['hláska', 'звук речи', 'noun'],
    ...
    ['vysloviť', 'произносить', 'verb'], ['vyslovovať', 'произнести', 'verb'],
  ],
  'Учеба и школа': [
    ['univerzita', 'университет', 'noun'], ['trieda', 'класс', 'noun'], ['kurz', 'курс', 'noun'],
    ['lekcia', 'урок', 'noun'], ['úloha', 'задание', 'noun'], ['zadanie', 'задание', 'noun'], ['skúška', 'экзамен', 'noun'],
    ...
    ['slovník', 'словарь', 'noun'], ['slovníček', 'словарик', 'noun'], ['slovo', 'слово', 'noun'],
    ...
    ['prestávka', 'перемена, перерыв', 'noun'], ['známka', 'оценка', 'noun'], ['hodnotenie', 'оценка', 'noun'],
    ['semester', 'семестр', 'noun'], ['prednáška', 'лекция', 'noun'], ['seminár', 'семинар', 'noun'],
    ['štúdium', 'учеба', 'noun'], ['vzdelanie', 'образование', 'noun'], ['vzdelávanie', 'образование', 'noun'],
    ...
    ['certifikát', 'сертификат', 'noun'], ['osvedčenie', 'свидетельство', 'noun'], ['diplom', 'диплом', 'noun'],
    ...
    ['precvičiť', 'тренировать', 'verb'], ['precvičovať', 'потренировать', 'verb'], ['prečítať', 'прочитать', 'verb'],
  ...
  'Хобби и досуг': [
    ...
    ['balík', 'посылка', 'noun'], ['zábava', 'развлечение', 'noun'], ['koníček', 'хобби', 'noun'], ['záľuba', 'увлечение', 'noun'],
  ...
  'Абстрактные понятия': [
    ...
    ['schopnosť', 'способность', 'noun'], ['vedomosť', 'знание', 'noun'], ['znalosť', 'знание', 'noun'],
    ['pozornosť', 'внимание', 'noun'], ['záujem', 'интерес', 'noun'], ['názor', 'мнение', 'noun'],
    ['myšlienka', 'мысль', 'noun'], ['nápad', 'идея', 'noun'], ['pravda', 'правда', 'noun'],
    ...
    ['bod', 'точка, пункт', 'noun'], ['skupina', 'группа', 'noun'], ['druh', 'вид', 'noun'], ['typ', 'тип', 'noun'],
    ...
    ['pomoc', 'помощь', 'noun'], ['zmena', 'изменение', 'noun'], ['výber', 'выбор', 'noun'], ['voľba', 'выбор', 'noun'],
    ...
    ['úsilie', 'усилие', 'noun'], ['snaha', 'старание', 'noun'], ['pokrok', 'прогресс', 'noun'], ['vývoj', 'развитие', 'noun'],
    ['rast', 'рост', 'noun'], ['pokles', 'снижение', 'noun'], ['vznik', 'возникновение', 'noun'],
    ['zánik', 'исчезновение', 'noun'], ['dôsledok', 'следствие', 'noun'], ['následok', 'последствие', 'noun'],
    ...
    ['úžitok', 'польза', 'noun'], ['prínos', 'вклад', 'noun'], ['škoda', 'ущерб, жаль', 'noun'], ['strata', 'потеря', 'noun'],
    ...
    ['výstraha', 'предупреждение', 'noun'], ['varovanie', 'предупреждение', 'noun'], ['príkaz', 'приказ', 'noun'], ['zákaz', 'запрет', 'noun'],
    ...
    ['tvoriť', 'создавать', 'verb'], ['vytvoriť', 'создать', 'verb'], ['zvýšiť', 'увеличить', 'verb'],
  ...
  'Эмоции и характер': [
    ...
    ['charakter', 'характер', 'noun'], ['povaha', 'характер', 'noun'], ['osobnosť', 'личность', 'noun'], ['osoba', 'лицо, человек', 'noun'],
    ...
    ['starostlivosť', 'забота', 'noun'], ['dôvera', 'доверие', 'noun'], ['rešpekt', 'уважение', 'noun'], ['úcta', 'уважение', 'noun'],
    ...
    ['plakať', 'плакать', 'verb'], ['milovať', 'любить', 'verb'], ['ľúbiť', 'любить', 'verb'], ['páčiť sa', 'нравиться', 'verb'],
  ],
  'Меры и величины': [
  ...
  'Страны и национальности': [
    ...
    ['cudzinec', 'иностранец', 'noun'], ['cudzinka', 'иностранка', 'noun'], ['cudzí', 'чужой, иностранный', 'noun'],
    ['obyvateľ', 'житель', 'noun'], ['obyvateľstvo', 'население', 'noun'],
    ['turista', 'турист', 'noun'],
  ],
  'Государство и политика': [
    ['štát', 'государство', 'noun'], ['republika', 'республика', 'noun'],
    ['región', 'регион', 'noun'], ['kraj', 'край', 'noun'], ['občan', 'гражданин', 'noun'],
    ...
    ['hlasovať', 'голосовать', 'verb'], ['voliť', 'голосовать', 'verb'], ['kandidovať', 'баллотироваться', 'verb'],
  ...
  'IT и техника': [
    ...
    ['hlásenie', 'уведомление', 'noun'], ['upozornenie', 'предупреждение', 'noun'], ['pokrytie', 'покрытие', 'noun'],
    ['operátor', 'оператор', 'noun'], ['podpora', 'поддержка', 'noun'],
    ['zdieľať', 'делиться', 'verb'], ['odoslať', 'отправить', 'verb'], ['preposlať', 'переслать', 'verb'],
    ['vyhľadať', 'искать', 'verb'], ['vyhľadávať', 'найти', 'verb'], ['uložiť', 'сохранить', 'verb'],
    ['vymazať', 'удалить', 'verb'], ['odstrániť', 'удалить', 'verb'], ['stiahnuť', 'скачать', 'verb'], ['nahrať', 'загрузить', 'verb'],
    ...
    ['inštalovať', 'устанавливать', 'verb'], ['nainštalovať', 'установить', 'verb'],
    ['nastaviť', 'настроить', 'verb'], ['nastavovať', 'настраивать', 'verb'],
  ...
  'Финансы и деньги': [
    ...
    ['majetok', 'имущество', 'noun'], ['vlastníctvo', 'собственность', 'noun'], ['nehnuteľnosť', 'недвижимость', 'noun'],
    ['pozemok', 'земельный участок', 'noun'], ['kaucia', 'залог', 'noun'], ['depozit', 'депозит', 'noun'],
    ...
    ['náhrada', 'компенсация', 'noun'], ['odškodnenie', 'возмещение', 'noun'],
    ...
    ['platiť', 'платить', 'verb'], ['zaplatiť', 'заплатить', 'verb'], ['kúpiť', 'купить', 'verb'], ['predať', 'продать', 'verb'],
  ...
  'Глаголы: работа и организация': [
    ...
    ['odovzdať', 'передать, сдать', 'verb'], ['odhadnúť', 'оценить приблизительно', 'verb'], ['odhadovať', 'оценить приблизительно', 'verb'],
    ['organizovať', 'организовывать', 'verb'], ['overiť', 'проверить', 'verb'], ['overovať', 'заверить', 'verb'],
    ['podporiť', 'поддержать', 'verb'], ['posúdiť', 'оценить', 'verb'],
    ['prenajať', 'сдать или взять в аренду', 'verb'], ['prenajímať', 'сдать или взять в аренду', 'verb'], ['prevziať', 'получить, перенять', 'verb'],
    ...
    ['odlišovať', 'отличать', 'verb'], ['líšiť', 'различать', 'verb'], ['dokázať', 'суметь', 'verb'], ['preukázať', 'доказать', 'verb'],
    ['zisťovať', 'выяснять', 'verb'], ['presvedčiť', 'убедить', 'verb'], ['presviedčať', 'убеждать', 'verb'],
    ['nesúhlasiť', 'не соглашаться', 'verb'], ['namietať', 'возражать', 'verb'],
    ['pamätať', 'помнить', 'verb'], ['pamätať si', 'помнить', 'verb'], ['zabudnúť', 'забыть', 'verb'], ['spomenúť', 'вспомнить', 'verb'],
    ...
    ['spolupracovať', 'сотрудничать', 'verb'], ['zamestnať', 'нанять', 'verb'], ['zamestnávať', 'нанимать', 'verb'],
    ['podnikať', 'заниматься бизнесом', 'verb'], ['riadiť', 'руководить', 'verb'], ['viesť', 'вести', 'verb'],
    ['dohliadať', 'контролировать', 'verb'], ['plniť', 'выполнять', 'verb'], ['splniť', 'выполнить', 'verb'],
    ['vyjednávať', 'договориться (переговоры)', 'verb'], ['dohodnúť', 'договориться (переговоры)', 'verb'], ['uzavrieť', 'заключить', 'verb'],
    ['fakturovať', 'выставлять счет', 'verb'], ['dodávať', 'поставлять', 'verb'],
    ['financovať', 'финансировать', 'verb'], ['nahlásiť', 'сообщить', 'verb'], ['ohlásiť', 'объявить', 'verb'],
